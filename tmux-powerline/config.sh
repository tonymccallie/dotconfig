...
# sqlite3 -list "/var/folders/37/5jdh999n3w1bc81lf9jwjk1h0000gn/0//com.apple.notificationcenter/db2/db" 'select * from app'
...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/tonymccallie/.mail/inbox/new"
...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/tonymccallie/.mailcheckrc"
# }
